...
namespace PharmacyManagement {
    ...
    public partial class PharmacyDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class SuppliersDataTable : global::System.Data.TypedTableBase<SuppliersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SuppliersRow AddSuppliersRow(string Name, string ContactPerson, string Phone, string Email, string Address) {
...
namespace PharmacyManagement.PharmacyDBDataSet1TableAdapters {
    ...
    public partial class SuppliersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Suppliers] ([Name], [ContactPerson], [Phone], [Email], [Address]) VALUES (@Name, @ContactPerson, @Phone, @Email, @Address);
SELECT SupplierID, Name, ContactPerson, Phone, Email, Address FROM Suppliers WHERE (SupplierID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Suppliers] SET [Name] = @Name, [ContactPerson] = @ContactPerson, [Phone] = @Phone, [Email] = @Email, [Address] = @Address WHERE (([SupplierID] = @Original_SupplierID) AND ([Name] = @Original_Name) AND ((@IsNull_ContactPerson = 1 AND [ContactPerson] IS NULL) OR ([ContactPerson] = @Original_ContactPerson)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT SupplierID, Name, ContactPerson, Phone, Email, Address FROM Suppliers WHERE (SupplierID = @SupplierID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SupplierID, Name, ContactPerson, Phone, Email, Address FROM dbo.Suppliers";
        ...
        public virtual int Fill(PharmacyDBDataSet1.SuppliersDataTable dataTable) {
        ...
        public virtual PharmacyDBDataSet1.SuppliersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PharmacyDBDataSet1.SuppliersDataTable dataTable = new PharmacyDBDataSet1.SuppliersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PharmacyDBDataSet1.SuppliersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_SupplierID, string Original_Name, string Original_ContactPerson, string Original_Phone, string Original_Email, string Original_Address) {
        ...
        public virtual int Insert(string Name, string ContactPerson, string Phone, string Email, string Address) {
            if ((Name == null)) {
        ...
        public virtual int Update(string Name, string ContactPerson, string Phone, string Email, string Address, int Original_SupplierID, string Original_Name, string Original_ContactPerson, string Original_Phone, string Original_Email, string Original_Address, int SupplierID) {
            if ((Name == null)) {
                throw new global::System.ArgumentNullException("Name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string ContactPerson, string Phone, string Email, string Address, int Original_SupplierID, string Original_Name, string Original_ContactPerson, string Original_Phone, string Original_Email, string Original_Address) {
            return this.Update(Name, ContactPerson, Phone, Email, Address, Original_SupplierID, Original_Name, Original_ContactPerson, Original_Phone, Original_Email, Original_Address, Original_SupplierID);
        }
    }
